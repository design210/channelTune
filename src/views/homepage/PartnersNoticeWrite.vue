...
export default {
  ...
  computed: {
    ...mapGetters("common", ["partnerNoticeWriteResult"]),
  },
  //데이터 불러오기
  methods: {
    statusCategory(data) {
    ...
    async save() {
      ...
      try {
        ...
        await this.$store.dispatch("common/PARTNER_NOTICE_WRITE", {
        ...
        const res = this.partnerNoticeWriteResult.channeltuneApiResult;
