  ...
  methods: {
    ...
    async reload(num) {
      ...
      try {
        ...
        const res = this.getContactList.channeltuneApiResult;
    ...
    async contactDetail(id) {
      try {
        ...
        const res = this.getcontactDetail.channeltuneApiResult;
        if (parseInt(res.errorCode) !== 200) {
          this.alim(res.errorMessage, this.errorColor);
          bus.$emit("end:spinner");
          return false;
    ...
    async modify() {
      try {
        ...
        const res = this.contactModifyResult.channeltuneApiResult;
        if (parseInt(res.errorCode) !== 200) {
          this.alim(res.errorMessage, this.errorColor);
          bus.$emit("end:spinner");
          return false;
      ...
      if (data.del === "Y") {
        if (data.type === "list") {
          try {
            ...
            const res = this.contactDeleteResult.channeltuneApiResult;
            if (parseInt(res.errorCode) !== 200) {
